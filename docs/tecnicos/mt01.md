...
<span style= "color: dodgeblue">Style - color / font-size / margin-left</span><br>
...
<span style= "color: dodgeblue">Span</span><br>
...
<span style="margin-left: 40px;">Importé imágenes en diversos pathways dentro de la carpeta main para practicar hacer las menciones.
