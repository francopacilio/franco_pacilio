...
Una vez hecho esto, debemos abrir el programa y agregar nuestra carpeta RepositorioLocal al software como un nuevo Workspace para poder editar los arhivos y realizar los Add, Commit y Push todo dentro de esta misma herramienta.