...
<p style="color: yellow;" >¡Felicitaciones! Ya tenemos nuestra SSH Key creada y lista para utilizar.</p>

Posteriormente podemoscopiarla al portapapeles con el comando: 
