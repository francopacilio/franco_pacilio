...
Implementé los comandos:

Style - color / font-size / margin-left<br>
<span style="margin-left: 80px;">Utilicé estilos para generar textos de diversos colores, tamaños y márgenes para facilitar la comprensión lectora.

Span<br>
<span style="margin-left: 80px;">Utilicé el comando span para poder utilizar los estilos sin que se me modifique la estructura del texto.

Br<br>
<span style="margin-left: 80px;">Utilicé el comando br para poder formular las líneas de texto correctamente.

Class<br>
<span style="margin-left: 80px;">Utilicé clases que extraí de erramientas AI las cuales me posibilitaron generar recursos visuales qué de lo contrario no sabría crear. Cómo por ejemplo el texto en <span class="rainbow">rainbow.</span>
