...
El primer corte dejó en evidencia un claro error en el diseño, como la pieza central del gato no tiene patas, no se sostiene y se cae al piso. En ese momento me puse manos a la obra y corregí el diseño 3D, para posteriormente exportar y generar un nuevo archivo de corte con esos detalles corregidos. 
...
![](../images/MT03/cortecortebase.png)
...
Si bien el diseño era de relativamente baja complejidad, me quedé muy satisfecho con el resultado, la prolijidad de los encastres, las curvaturas y la exploración final para obtener detalles más precisos.
